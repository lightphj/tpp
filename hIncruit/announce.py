...
def announcementList(request):
    ...
    for p in tfp:
        ...
        if p.category == '2':
            ...
            imageUrl_bind = 'https://png.pngtree.com/png-vector/20190701/ourlarge/pngtree-construction-house-icon-in-trendy-style-isolated-background-png-image_1526491.jpg'
        elif p.category == '4':
            ...
            imageUrl_bind = 'https://image.shutterstock.com/image-photo/ict-information-communication-technology-concept-260nw-1262757361.jpg'
        elif p.category == '5':
